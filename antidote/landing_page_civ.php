  ...
  <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link page-scroll" href="home.php">Search</a>
        </li>
        <li class="nav-item">
          <a class="nav-link page-scroll" href="myChats.php">Chats</a>
        </li>

        <!-- Dropdown Menu -->
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle page-scroll" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">My Points</a>
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href = "#"><span class="item-text"><?php
            $points = $mysqli->query("SELECT points from civilians where email = '$email'");
