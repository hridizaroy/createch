        ...
        <script>
            ...
            function send() {
                ...
                if (document.querySelector('.chat').value != "") {
                    ...
                    const params = "user=" + '<?php echo $email; ?>' + "&chatContent=" + document.querySelector('.chat').value + "&time=" + time + "&fullDate=" + fullDate + "&police=" + '<?php echo $officer; ?>';
            ...
            function getChats(){
                ...
                const params = "user=" + '<?php echo $email; ?>' + "&police=" + '<?php echo $officer; ?>';
