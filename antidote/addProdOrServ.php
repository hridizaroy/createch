<?php
    ...
    if (isset($_POST['Add'])) {
        ...
        $sql = "INSERT INTO prods (pType, title, descript, expiry, email)" . " VALUES ('$type', '$title', '$desc', '$expiry', '$email')";
        ...
        if ( $mysqli->query($sql) ){
            ...
            if ($getUsers != false) {
                ...
                foreach ($users as $user) {
                    $subject = "New Product/Service near you! (Anti-dote)";
...
<head>
    <title>Add Product or Service</title>
    <!-- Styles -->
