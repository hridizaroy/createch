  ...
  <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link page-scroll" href = "#benefits">BENEFITS <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link page-scroll" href = "teams.php">MY TEAMS</a>
        </li>
        <li class="nav-item">
          <a class="nav-link page-scroll" href = "chatThreads.php">CHAT THREADS</a>
        </li>
        <li class="nav-item">
